...
function wanderer_thinker1:OnCreated()
	if IsServer() then
...
function wanderer_thinker1:OnIntervalThink()
	thinker = self:GetParent()
	vLocation = thinker:GetAbsOrigin()
	thinker:GetForceDrawOnMinimap()
