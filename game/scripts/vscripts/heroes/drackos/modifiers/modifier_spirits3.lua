...
function modifier_spirits3:OnCreated()
	...
	if target:HasModifier("modifier_spirits") then
		i = i+1
	end
...
function modifier_spirits3:OnDestroy()
	stacks = target:GetModifierStackCount("modifier_spirits_tracker", caster)
	if stacks == 1 then
...
function modifier_spirits3:IsHidden()
	return true
end